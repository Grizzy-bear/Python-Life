...
import random
import json
# url = "https://www.ximalaya.com/revision/play/album?albumId=9723091&pageNum=1&sort=0&pageSize=30"
UA_LIST = [
...
for i in range(1,7):
    ...
    url = "https://www.ximalaya.com/revision/play/album?albumId=9723091&pageNum={}&sort=0&pageSize=30".format(i)
...
# print(result)
    fileJson = codecs.open('GWD0{}.json'.format(i), 'a','utf-8')
    fileJson.write(result)
    fileJson.close()
